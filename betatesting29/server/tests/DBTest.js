...
var initialRecord = "value";
var recordId = "";
var updateRecord = "new_value";
/**
 * Test suite
 */
describe('Postgres-DB-Unit Test', function () {
    ...
    describe('CRUD operations', function () {
        ...
        it("should be able to Insert record", function (done) {
            ...
            objDbConnection.one("INSERT INTO TableName (columnName) VALUES ($1) RETURNING *", [initialRecord])
                .then(function (data) {
                    result = data;
                    ...
                    result.should.have.property('columnName');
                    recordId = result._id;
                    done();
                }, function () {
        ...
        it('should be able to retrieve all records', function (done) {
            objDbConnection.query("SELECT * FROM TableName")
        ...
        it('should be able to Update record', function (done) {
            ...
            objDbConnection.result("UPDATE TableName SET columnName=($1) WHERE _id=($2) RETURNING *", [updateRecord, recordId])
                .then(function (result) {
        ...
        it('should be able to delete record', function (done) {
            // Retrieve the data to insert from the POST body
            objDbConnection.result("DELETE FROM TableName WHERE _id=($1)", [recordId])
                .then(function (result) {
