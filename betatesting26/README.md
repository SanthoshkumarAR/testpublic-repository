...
* *CouchDB* - <a href="https://dl.bintray.com/apache/couchdb/mac/1.6.1/Apache-CouchDB-1.6.1.zip">Download</a> and Install CouchDB - <a href="http://docs.couchdb.org/en/1.6.1/">Checkout their manual</a> if you're just starting.
...
### Windows
* *Node.js* - <a href="http://nodejs.org/download/">Download</a> and Install Node.js, nodeschool has free <a href=" http://nodeschool.io/#workshoppers">node tutorials</a> to get you started.
* *CouchDB* - Follow the great tutorial from the CouchDB site - <a href="https://dl.bintray.com/apache/couchdb/win/1.6.1/setup-couchdb-1.6.1_R16B02.exe">"Install CouchDB On Windows"</a>


### OSX
* *Node.js* -  <a href="http://nodejs.org/download/">Download</a> and Install Node.js or use the packages within brew or macports.
* *CouchDB* - Follow the tutorial here - <a href="https://dl.bintray.com/apache/couchdb/mac/1.6.1/Apache-CouchDB-1.6.1.zip">Install CouchDB on OSX</a>
  ...
  "data": [
    {
      ...
      "_rev": "1-606067b52b983d3a00708a207d7ac1c0",
      "task_name": "one"
    },
    {
      "_id": "4d6153cf4bc3bdaf9c6c7eebf42d67a6",
      "_rev": "2-81ba2d490fa255eeb55287e16cb2c79c",
      "task_name": "two"
    },
    {
      "_id": "be3855e004dd5d74c802992c09ea8d28",
      "_rev": "1-a5521e8c20a5b95e6b485c28eb0e5391",
      "task_name": "three"
    }
  ]
}
...
```
{
  ...
  "data": {
    ...
    "_rev": "1-0b4e068543cf691edd52b331f1b70bef",
    "task_name": "two"
  }
}
```
...
**Request Body:**  
    ...
    {"task_name":"sample", "revID":"1-0b4e068543cf691edd52b331f1b70bef"}
...
```
{
  ...
  "data": {
    "_id": "4d6153cf4bc3bdaf9c6c7eebf42d67a6",
    "_rev": "3-291599e4102be697fdf00ef7dab64fd5",
    "task_name": "sample"
  }
}
```
...
CouchDB is a database that completely embraces the web. CouchDB works well with modern web and mobile apps. The data in the CouchDB are stored as JSON documents.  CouchDB allows to distribute data, or apps, efficiently using CouchDB’s incremental replication. CouchDB supports master-master setups with automatic conflict detection.The sample app provided performs basic CRUD operations, for managing data in a simple "To Do" app.



#### Files related to CouchDB

The crux of the DB operations are present in the DBHandler file, present in the controllers directory. The database connection establishment and the CRUD operations are given in this file. The "nano" node module is used to connect to the database.
...
The Application can be run locally or deployed in cloud foundry and in both scenarios CouchDB service has to be integrated with the application.
...
`  "service_name":"couchdb", `  // The service instance name created in cloud foundry 
...
##### Creating CouchDB DB service

- To create a service instance in Bluemix, run

```sh
$ cf create-service cloudantNoSQLDB Shared service_instance_name 
$ cf bind-service AppName service_instance_name
```
- To create a service instance in other PAAS platform, run
