...
describe('<Unit Test>', function () {
        ...
        it('should be able to POST task without problems', function (done) {
            this.request.post('/api/todos')
                ...
                .end(function (err, res) {
                    ...
                    mqHandler.startPublisher(res.body.task_name + ' task added');
                }
                    done();
                });
        });
    ...
    after(function (done) {
        // Close RabbitMQ connection after publishing message
        mqHandler.closeOnErr("close rabbitmq connection");
        done();
    })
});
